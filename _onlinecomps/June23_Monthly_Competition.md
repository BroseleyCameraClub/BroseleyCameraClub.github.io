...
<p>Title for the competition is <strong>Lake</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/June23_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for june23MonAuth in site.data.june23MonAuth %}
      {% if image.basename == june23MonAuth.Img_Name %}
<div class="subName">By - {{ AAAjune23MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for june23MonAuth in site.data.june23MonAuth %}
        {% if image.basename == june23MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAjune23MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
