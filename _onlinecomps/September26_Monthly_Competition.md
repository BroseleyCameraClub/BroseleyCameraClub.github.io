...
<p>Title for the competition is <strong>Cafe / Pub Life</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/September26_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for sept26MonAuth in site.data.sept26MonAuth   %}
      {% if image.basename == sept26MonAuth.Img_Name %}
<div class="subName">By - {{ AAAsept26MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for sept26MonAuth in site.data.sept26MonAuth   %}
        {% if image.basename == sept26MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAsept26MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
