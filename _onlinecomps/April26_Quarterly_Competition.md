...
<p>Title for the competition is <strong>Abstract</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/April26_Quarterly/' %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for apr26QtrAuth in site.data.apr26QtrAuth   %}
        {% if image.basename == apr26QtrAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAapr26QtrAuth.Author }}</div>
        {% endif %}
    {% endfor %}
