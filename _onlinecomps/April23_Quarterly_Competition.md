...
<!-- This runs and checks if there is a matching author in the file -->
    {% for apr23QuaAut in site.data.apr23QuaAut %}
      {% if image.basename == apr23QuaAut.Img_Name %}
<div class="subName">By - {{ AAAapr23QuaAut.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for apr23QuaAut in site.data.apr23QuaAut %}
        {% if image.basename == apr23QuaAut.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAapr23QuaAut.Author }}</div>
        {% endif %}
    {% endfor %}
