...
<p>Title for the competition is <strong>Summer</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/October23_Quarterly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for oct23QtrAuth in site.data.oct23QtrAuth   %}
      {% if image.basename == oct23QtrAuth.Img_Name %}
<div class="subName">By - {{ AAAoct23QtrAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for oct23QtrAuth in site.data.oct23QtrAuth %}
        {% if image.basename == oct23QtrAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAoct23QtrAuth.Author }}</div>
        {% endif %}
    {% endfor %}
