...
<p>Title for the competition is <strong>Light & Dark</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/February26_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for feb26MonAuth in site.data feb26MonAuth   %}
      {% if image.basename == feb26MonAuth.Img_Name %}
<div class="subName">By - {{ AAAfeb26MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for feb26MonAuth in site.data feb26MonAuth %}
        {% if image.basename == feb26MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAfeb26MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
