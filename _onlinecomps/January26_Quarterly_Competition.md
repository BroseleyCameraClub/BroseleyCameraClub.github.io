...
<p>Title for the competition is <strong>Walk in the Woods in Winter</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/January26_Quarterly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for jan26QtrAuth in site.data.jan26QtrAuth   %}
      {% if image.basename == jan26QtrAuth.Img_Name %}
<div class="subName">By - {{ AAAjan26QtrAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for jan26QtrAuth in site.data.jan26QtrAuth %}
        {% if image.basename == jan26QtrAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAjan26QtrAuth.Author }}</div>
        {% endif %}
    {% endfor %}
