...
<p>Title for the competition is <strong>Stormy Weather</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/October25_Quarterly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for oct25QtrAuth in site.data.oct25QtrAuth   %}
      {% if image.basename == oct25QtrAuth.Img_Name %}
<div class="subName">By - {{ AAAoct25QtrAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for oct25QtrAuth in site.data.oct25QtrAuth %}
        {% if image.basename == oct25QtrAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAoct25QtrAuth.Author }}</div>
        {% endif %}
    {% endfor %}
