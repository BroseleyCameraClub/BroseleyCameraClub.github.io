...
<p>Title for the competition is <strong>Food and Drink</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/May24_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for may24MonAuth in site.data.may24MonAuth   %}
      {% if image.basename == may24MonAuth.Img_Name %}
<div class="subName">By - {{ AAAmay24MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for may24MonAuth in site.data.may24MonAuth %}
        {% if image.basename == may24MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAmay24MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
