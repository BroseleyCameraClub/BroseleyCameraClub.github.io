...
<p>Title for the competition is <strong>Outside Markets</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/June26_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for june26MonAuth in site.data.june26MonAuth   %}
      {% if image.basename == june26MonAuth.Img_Name %}
<div class="subName">By - {{ AAAjune26MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for june26MonAuth in site.data.june26MonAuth   %}
        {% if image.basename == june26MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAjune26MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
