...
<p>Title for the competition is <strong>Waste / Recycling</strong></p> 
...
{% for image in site.static_files %}
    {% if image.path contains 'assets/img/January26_Monthly/' %}
<div class="Number">{{ image.basename }}</div>

<!-- This runs and checks if there is a matching author in the file -->
    {% for jan26MonAuth in site.data.jan26MonAuth   %}
      {% if image.basename == jan26MonAuth.Img_Name %}
<div class="subName">By - {{ AAAjan26MonAuth.Author }}</div>
      {% endif %}
    {% endfor %}
...
<div class="grid__item" data-size="1280x1280">  
    ...
    {% for jan26MonAuth in site.data.jan26MonAuth %}
        {% if image.basename == jan26MonAuth.Img_Name %}
<div class="description description--grid">{{ image.basename }} - {{ AAAjan26MonAuth.Author }}</div>
        {% endif %}
    {% endfor %}
